...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "Token is already owned by recipient");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "Sender is neither approved, not owner");
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    uint256[] private _allTokens = new uint256[](0);
...
contract LuToken is ERC721Metadata("Lu Token", "LU", "https:\x2f\x2fs3-us-west-2.amazonaws.com\x2fudacity-blockchain\x2fcapstone\x2f")
{
